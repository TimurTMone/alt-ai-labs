  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white px-6 py-12 relative">
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <p className="text-[14px] text-zinc-500 text-center mb-12">Start free. Upgrade when you&apos;re ready to go pro.</p>

        <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <div className="rounded-2xl p-8 glass">
            <h3 className="font-semibold text-lg mb-1">{PRICING.free.name}</h3>
            <div className="text-4xl font-bold mb-6">$0<span className="text-base font-normal text-zinc-600">/mo</span></div>
            ...
            <Link href="/signup" className="block w-full border border-white/[0.08] text-zinc-400 hover:text-white hover:bg-white/[0.04] h-10 text-[13px] rounded-xl transition-colors text-center leading-10">
              Get Started
            </Link>
          </div>
          ...
          <div className="rounded-2xl p-8 glass glow-amber relative">
            ...
            <div className="text-4xl font-bold mb-6">${PRICING.paid.price}<span className="text-base font-normal text-zinc-600">/mo</span></div>
            <ul className="space-y-3 mb-8">
