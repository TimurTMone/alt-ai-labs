    ...
    return (
      <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 relative">
        ...
        <div className="w-full max-w-md relative text-center">
          ...
          <p className="text-sm text-zinc-400 mb-2">We&apos;ll notify <span className="text-white font-medium">{email}</span> when your spot is ready.</p>
          <p className="text-sm text-zinc-600 mb-8">Early members get priority access + founding member perks.</p>

          <div className="rounded-2xl p-6 bg-white/[0.02] border border-white/[0.06] mb-6">
            <h3 className="text-sm font-semibold text-zinc-400 mb-4 uppercase tracking-wider">While you wait</h3>
            <p className="text-sm text-zinc-300 mb-5">Explore the full platform in preview mode — browse drops, check out the classroom, and see what builders are shipping.</p>
            <button
              onClick={handleExplore}
              className="w-full bg-blue-500 hover:bg-blue-400 text-white h-11 text-sm font-semibold rounded-xl transition-all duration-200 shadow-[0_0_20px_rgba(59,130,246,0.15)] flex items-center justify-center gap-1.5"
            >
    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-[380px] relative">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-2">Get early access to Alt AI Labs — learn AI by building real products every week.</p>
        </div>
        ...
        {/* OAuth — instant signup via Render backend */}
        <div className="space-y-2.5 mb-4">
          <a
            href={`${API_URL}/api/auth/apple`}
            className="w-full bg-white text-black hover:bg-zinc-100 h-12 text-sm font-semibold rounded-xl transition-colors flex items-center justify-center gap-2.5"
          >
        ...
        <div className="relative mb-4">
          ...
          <div className="relative flex justify-center text-xs"><span className="bg-[#09090b] px-3 text-zinc-600">or join the waitlist</span></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={status === 'loading'} className="w-full disabled:opacity-50 text-white h-12 text-sm font-semibold rounded-xl btn-primary transition-all duration-200 flex items-center justify-center gap-1.5">
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/[0.06]" /></div>
          <div className="relative flex justify-center text-xs"><span className="bg-[#09090b] px-3 text-zinc-600">or explore first</span></div>
        </div>

        <button onClick={handleExplore} className="w-full border border-white/[0.08] text-zinc-400 hover:text-white hover:bg-white/[0.04] h-10 text-sm rounded-xl transition-colors flex items-center justify-center gap-1.5">
