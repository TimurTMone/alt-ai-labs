    ...
    <div className="min-h-screen bg-[#0a0a0c] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-[360px] relative">
        <div className="text-center mb-8">
          ...
          <p className="text-[13px] text-neutral-500 mt-1.5">Start building AI systems today</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="name" className="text-[13px] text-neutral-400">Full Name</Label>
            <Input id="name" value={fullName} onChange={e => setFullName(e.target.value)} required className="h-10 bg-white/[0.04] border-white/[0.08] text-white rounded-xl text-[13px] placeholder:text-neutral-600" placeholder="Your name" />
          </div>
          <div className="space-y-1.5">
