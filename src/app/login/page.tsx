    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-[380px] relative">
        ...
        <button
          ...
          className="w-full border border-white/[0.08] text-zinc-300 hover:text-white hover:bg-white/[0.04] h-11 text-[13px] font-medium rounded-xl transition-colors flex items-center justify-center gap-2"
        >
