  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-[380px] relative">
        ...
        {authError && (
          <div className="mb-4 p-3 rounded-xl bg-orange-500/10 border border-orange-500/20 text-[13px] text-orange-400 text-center">
        ...
        <div className="space-y-2.5">
          <a
            ...
            className="w-full bg-white text-black hover:bg-zinc-100 h-11 text-[13px] font-semibold rounded-xl transition-colors flex items-center justify-center gap-2.5"
          >
          ...
          <a
            ...
            className="w-full border border-white/[0.08] text-zinc-300 hover:text-white hover:bg-white/[0.04] h-11 text-[13px] font-medium rounded-xl transition-colors flex items-center justify-center gap-2.5"
          >
        ...
        {!showLogin ? (
          ...
          <>
            <div className="relative my-6">
              <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/[0.06]" /></div>
              <div className="relative flex justify-center text-[11px]"><span className="bg-[#09090b] px-3 text-zinc-600">sign in with email</span></div>
            </div>
